...
const homethreeNav = () => {
  return (
    <header className="bg-black text-white py-4 px-4 md:px-0  z-50"> {/* Higher z-index for header */}
...
<div className="absolute top-30 right-28 w-full md:w-[450px] h-[400px] md:h-[542px] max-md:h-[100px] bg-[#D9D9D9] z-10 flex flex-col pt-4 md:pt-8 pr-4">
